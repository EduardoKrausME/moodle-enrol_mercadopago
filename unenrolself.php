...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'mercadopago'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/mercadopago/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_mercadopago', format_string($course->fullname));
